...
export class SlIcon {
  ...
  render() {
    return this.colored ? (
      <scale-icon fill="var(--scl-color-primary, #e20074)" path={FILLED_STAR} />
    ) : (
      <scale-icon path={BLANK_STAR} />
    );
  }
}
