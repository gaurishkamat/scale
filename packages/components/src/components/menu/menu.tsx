...
export class Menu {
  ...
  slottedList: HTMLScaleMenuListElement;
  ...
  calculateCascadeLevel() {
    ...
    do {
      if (elem.tagName === 'SCALE-MENU-LIST') {
        level++;
      }
      elem =
  ...
  onMenuClick(event: MouseEvent) {
    ...
    const item = target.closest('scale-menu-item') as HTMLScaleMenuItemElement;
