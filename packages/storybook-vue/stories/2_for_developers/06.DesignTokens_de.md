...
Um die Tokens zu nutzen, importiere sie aus dem Package `@scaleds/design-tokens`.

- `@scaleds/design-tokens/dist/design-tokens.css` für **CSS**
- `@scaleds/design-tokens/dist/design-tokens.js` für **JavaScript** (oder CSS-in-JS)
