...
Um die Telekom Design Tokens zu nutzen, importiere sie aus dem Package `@scaleds/telekom-design-tokens`.

- `@scaleds/telekom-design-tokens/dist/design-tokens-telekom.css` für **CSS**
- `@scaleds/telekom-design-tokens/dist/design-tokens-telekom.js` für **JavaScript** (oder CSS-in-JS)
