...
To use the tokens, import them from the `@scaleds/design-tokens` package

- `@scaleds/design-tokens/dist/design-tokens.css` for **CSS**
- `@scaleds/design-tokens/dist/design-tokens.js` for **JavaScript** (or CSS-in-JS)
