...
| ------------- | --------------- | -------------- | --------------------------------------- |
| **Body**      |                 |                |                                         |
| Body short    | \$body-short-01 | `<p>`          | ![Image Name](/assets/2_guidelines/3_typography/image2020-8-3_15-11-56.png) |
| Body long     | \$body-long-01  | `<p>`          | ![Image Name](/assets/2_guidelines/3_typography/image2020-8-3_15-11-47.png) |
| Body large    | \$body-large-01 | `<p>`          | ![Image Name](/assets/2_guidelines/3_typography/image2020-8-3_15-11-40.png) |
| **Headlines** |                 |                |                                         |
