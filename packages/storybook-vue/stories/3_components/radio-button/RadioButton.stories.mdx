...
```html
<scale-radio-button disabled @scaleChange="handleChange"></scale-radio-button>
```
...
```html
<scale-radio-button checked @scaleChange="handleChange"></scale-radio-button>
```
...
```html
<scale-radio-button checked disabled @scaleChange="handleChange"></scale-radio-button>
```
...
```html
<scale-radio-button status="error" helper-text="This is the error message" @scaleChange="handleChange"></scale-radio-button>
```
