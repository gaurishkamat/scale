          ...
          <scale-app-shell>
            ...
            >
                <div slot="menu-main">
                  ...
                  <scale-nav-main name="Custom Item #2" id="nav-main-with-mega-menu" ref="navMainWithMegaMenu" @mouseenter="handleMouseEnter" @mouseleave="handleMouseLeave">
                    <app-mega-menu>
...
```html
  <scale-app-shell>
    ...
    >
        <div slot="menu-sector">
          <scale-nav-segment is-active="true" href="#custom-sector-1" @click="handleClick">
            Custom Sector #1
          </scale-nav-segment>
...
```html
  <scale-app-shell>
    ...
    >
        <div slot="menu-addon">
          <scale-nav-segment is-active="true" href="#custom-addon-1" @click="handleClick">
            Custom Addon #1
          </scale-nav-segment>
      ...
      mounted () {
          document.body.addEventListener('keydown', (event) => {
              if (['Escape', 'Esc'].includes(event.key)) {
                  ...
                  this.$refs.header && this.$refs.header.dispatchEvent(new Event('closeMenu'));
              }
          });
      }
    })}
