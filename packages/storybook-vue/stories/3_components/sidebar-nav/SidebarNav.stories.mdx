  ...
  template: `
    <div :style="wrapperStyles">
      ...
      >
        ...
        <scale-sidebar-nav-collapsible label="Reference" active>
          <scale-sidebar-nav-collapsible label="Function A" active>
...
<Canvas withSource="none">
  <Story name='Standard' args={{ collapsible: true, collapsibleLabel: 'Explore this topic' }}>
    {Template.bind({})}
  </Story>
</Canvas>
...
<scale-sidebar-nav aria-label="primary">
  ...
  <scale-sidebar-nav-collapsible label="Reference">
    <scale-sidebar-nav-collapsible label="Function A">
      <scale-sidebar-nav-item>
        <a href="#">Endpoint 1</a>
      </scale-sidebar-nav-item>
      <scale-sidebar-nav-item>
    ...
    <scale-sidebar-nav-collapsible label="Function C">
