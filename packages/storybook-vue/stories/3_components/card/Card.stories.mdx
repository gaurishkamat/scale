                        ...
                        >
                          <article style="margin: -24px;">
                              ...
                              <div style="padding: 24px;">
                                ...
                                <div style="padding: 0 0 24px 0; display: flex; justify-content: center;"><scale-button>Label</scale-button></div><EXTERNAL_FRAGMENT></EXTERNAL_FRAGMENT>
                                <div style="display: flex; justify-content: flex-end;"><scale-link href="#more" tabindex=0>More...</scale-link></div>
                              </div>
                          </article>
                    </scale-card>
                </div>
