...
const Breadcrumb = class {
    ...
    render() {
        ...
        return (h(Host, null, h("style", null, this.stylesheet.toString()), h("nav", { "aria-label": "Breadcrumb", class: this.getCssClassMap() }, h("ol", null, this.linksArray.map((element, index) => {
...
const Carousel = class {
    ...
    render() {
        const { classes } = this.stylesheet;
        return (h(Host, null, h("style", null, this.stylesheet.toString()), h("div", { class: this.getCssClassMap() }, h("div", { class: classes.carousel__container }, h("div", { class: `${classes.carousel__arrow} ${classes['carousel__arrow--left']}`, onClick: () => this.handleSlideChange('prev') }, h("slot", { name: "arrow-left" })), this.slidesArray.map(element => (h("div", { class: classes.carousel__slide, style: { transform: this.setTransformValue() } }, h("div", { innerHTML: element.outerHTML })))), h("div", { class: `${classes.carousel__arrow} ${classes['carousel__arrow--right']}`, onClick: () => this.handleSlideChange('next') }, h("slot", { name: "arrow-right" }))), h("ul", { class: classes.carousel__indicators }, Array.from(Array(this.slidesArray.length).keys()).map(index => (h("li", { key: index, class: `${classes.carousel__indicator} ${this.setActiveCssClass(index)}`, onClick: () => this.setActiveSlide(index) })))))));
    }
    getCssClassMap() {
        const { classes } = this.stylesheet;
...
const Input = class {
    ...
    render() {
        if (this.type === 'checkbox') {
            return (h(Host, null, h("style", null, this.stylesheet.toString()), h("div", { class: this.getCssClassMap() }, h("div", { class: classnames('input__checkbox-container') }, h("input", { type: "checkbox", name: this.name, class: classnames('input__checkbox'), id: this.inputId, onChange: event => this.handleChange(event), value: this.value, checked: this.checked, disabled: this.disabled }), h("span", { class: classnames('input__checkbox-placeholder'), tabIndex: 1 }), !!this.checked && !!this.icon && (h("scale-icon", { path: this.icon }))), h("label", { class: "input__label", htmlFor: this.name }, this.label))));
        }
        if (this.type === 'radio') {
            return (h(Host, null, h("style", null, this.stylesheet.toString()), h("div", { class: this.getCssClassMap() }, h("input", { type: "radio", name: this.name, class: classnames('input__radio'), id: this.inputId, onChange: event => this.handleChange(event), value: this.value, checked: this.preChecked, disabled: this.disabled }), h("label", { class: "input__label", htmlFor: this.inputId }, this.label))));
        }
