...
var merge_1 = merge;
var combineObjects = function (a, b) { return merge_1({}, a, b); };
var defaultTheme = {
    colors: {
        common: {
            black: '#000',
...
var THEME_MAGIC_STRING = 'ʕ•ᴥ•ʔ theme store magic placeholder ʕ•ᴥ•ʔ';
var store = typeof window !== 'undefined' && typeof window.Audio !== 'undefined'
    ? window
    : { scale: { theme: THEME_MAGIC_STRING } };
var getTheme = function (overrides) {
    var scale = store.scale;
    if (scale) {
        var injectedTheme = typeof scale.theme === 'object' && scale.theme;
        if (injectedTheme) {
...
export { THEME_MAGIC_STRING as T, combineObjects as a, createCommonjsModule as c, defaultTheme as d, getTheme as g, useTheme as u };
