...
var scheduleUpdate = function (hostRef, isInitialLoad) {
    ...
    var update = function () { return updateComponent(hostRef, instance); };
            ...
            var hostId = void 0;
            {
                ...
                if (hostId) {
                    if (supportsShadow && cmpMeta.$flags$ & 1 /* shadowDomEncapsulation */) {
                        var scopeId_1 = addStyle(elm.shadowRoot, cmpMeta);
                        elm.classList.remove(scopeId_1 + '-h', scopeId_1 + '-s');
                    }
...
var patchEsm = function () {
    ...
    if (!(CSS && CSS.supports && CSS.supports('color', 'var(--c)'))) {
        // @ts-ignore
        return import(/* webpackChunkName: "stencil-polyfills-css-shim" */ './css-shim-9cf83bbd.js').then(function () {
...
var patchBrowser = function () {
    ...
    }
    {
        ...
        if (!win.customElements) {
            ...
            // @ts-ignore
            return import(/* webpackChunkName: "stencil-polyfills-dom" */ './dom-4dc582fc.js').then(function () { return opts; });
        }
    }
