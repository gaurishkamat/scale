...
@ProxyCmp({
  inputs: ['customClass', 'disabled', 'href', 'interactive', 'styles', 'target']
})
@Component({
  selector: 'scale-card',
  changeDetection: ChangeDetectionStrategy.OnPush,
...
@ProxyCmp({
  inputs: ['iconSize', 'isExpanded', 'label', 'styles', 'tag'],
...
@ProxyCmp({
  inputs: ['cols', 'counter', 'customClass', 'disabled', 'helperText', 'icon', 'inputId', 'label', 'maxLength', 'minLength', 'multiple', 'name', 'placeholder', 'preChecked', 'required', 'resize', 'rows', 'size', 'status', 'styles', 'transparent', 'type', 'value', 'variant', 'visibleSize']
})
@Component({
...
@ProxyCmp({
  inputs: ['block', 'customClass', 'disabled', 'href', 'icon', 'iconSize', 'styles', 'target', 'underline', 'variant']
})
@Component({
  selector: 'scale-link',
  changeDetection: ChangeDetectionStrategy.OnPush,
...
@ProxyCmp({
  inputs: ['customClass', 'customColor', 'disabled', 'label', 'max', 'min', 'showValue', 'step', 'styles', 'trackHeight', 'value']
})
@Component({
...
@ProxyCmp({
  inputs: ['active', 'customClass', 'disabled', 'iconOff', 'iconOn', 'iconSize', 'styles', 'textOff', 'textOn']
})
@Component({
